    ...
    return (
        <div className="wrapper m-20">
            <div className="green-light">
                ...
                <div className="flex">
                    <div className="flex col flex-column p-1">
                        <p className="text-xl">Lead Developer at Ferguson Enterprises</p>
                        <p className="text-md gray">August 2021 - December 2023</p>
                    ...
                    <div className="flex col flex-column p-1">
                        <p className="text-xl">Application programmer II at Bank of America</p>
                        <p className="text-md gray">June 2020 - November</p>
                        <section className="scroller">
                            <p className="text-md list-item green-light">
                                <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10">
                                    <path stroke="#93E5AB" d="M9.5 9.5H1.207L9.5 1.207V9.5z" />
