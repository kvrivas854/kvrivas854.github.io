                    ...
                    <div>
                        <ul className="nav nav-tabsfinder flex text-sm">
                            <li className="nav-item hover">
                                <Link className={`link ${pathname === '/' ? 'nav-link active' : 'nav-link'}`} href="/about">
                                    About
                                </Link>
                            </li>
                            <li className="nav-item hover">
                                <Link className={`link ${pathname === '/experience' ? 'nav-link active' : 'nav-link'}`} href="/experience">
                                    Experience
                                </Link>
                            </li>
                            <li className="nav-item hover">
                                <Link className={`link ${pathname === '/project' ? 'nav-link active' : 'nav-link'}`} href="/project">
                                    Projects
                                </Link>
                            </li>
                        </ul>
